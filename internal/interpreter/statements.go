...
// §3.1). The right-hand side must be a List with at least N-1 elements
// for N targets; every target but the last takes one element
// positionally, and the last always takes a List of everything left
